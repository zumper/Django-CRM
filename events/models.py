...
class Event(models.Model):
  ...
  opportunities = models.ManyToManyField(Opportunity, blank=True, related_name='event_opportunity')
  assigned_to = models.ManyToManyField(User, blank=True, related_name='event_assigned')
  ...
  created_by = models.ForeignKey(User, related_name='event_created_by_user', null=True, on_delete=models.SET_NULL)
