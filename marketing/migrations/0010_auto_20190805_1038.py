...
class Migration(migrations.Migration):
  ...
  operations = [
    ...
    migrations.AlterField(
      ...
      name='campaign',
      field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campaign_link_click',
                              to='marketing.Campaign'),
    ),
    migrations.AlterField(
      model_name='campaignlog',
      name='campaign',
      field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campaign_log_contacts',
                              to='marketing.Campaign'),
    ),
