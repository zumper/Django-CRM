  ...
  operations = [
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('status', models.CharField(
          choices=[('Scheduled', 'Scheduled'), ('Cancelled', 'Cancelled'), ('Sending', 'Sending'),
                   ('Preparing', 'Preparing'), ('Sent', 'Sent')], default='Preparing', max_length=20)),
      ],
    ),
    migrations.CreateModel(
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campaign_contacts',
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('contact_number', models.CharField(blank=True, max_length=20, null=True, validators=[
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                         related_name='marketing_contactlist', to=settings.AUTH_USER_MODEL)),
      ],
    ),
    migrations.CreateModel(
      name='EmailTemplate',
      fields=[
        ...
        ('html', models.TextField()),
        ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                         related_name='marketing_emailtemplates', to=settings.AUTH_USER_MODEL)),
      ],
    ),
    migrations.CreateModel(
      name='Link',
      fields=[
        ...
        ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marketing_links',
                                       to='marketing.Campaign')),
      ],
    ),
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('created_by',
         models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='marketing_tags',
    ...
    migrations.AddField(
      ...
      field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                              related_name='marketing_contacts_created_by', to=settings.AUTH_USER_MODEL),
    ),
    migrations.AddField(
    ...
    migrations.AddField(
      ...
      name='contact',
      field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                              related_name='marketing_campaign_logs', to='marketing.Contact'),
    ),
    migrations.AddField(
    ...
    migrations.AddField(
      ...
      name='created_by',
      field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                              related_name='marketing_campaigns_created_by', to=settings.AUTH_USER_MODEL),
    ),
    migrations.AddField(
      model_name='campaign',
      name='email_template',
