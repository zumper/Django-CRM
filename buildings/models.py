...
class Building(models.Model):
  ...
  address = models.ForeignKey(Address, related_name='buildings', on_delete=models.SET_NULL, blank=True, null=True)
  deal = models.ForeignKey(Deal, on_delete=models.SET_NULL, related_name='buildings', blank=True, null=True)
  ...
  zumper_id = models.BigIntegerField(db_index=True, unique=True, blank=True, null=True)
  zumper_agent_id = models.BigIntegerField(blank=True, null=True)
  zumper_brokerage_id = models.BigIntegerField(blank=True, null=True)
...
class BuildingAdmin(admin.ModelAdmin):
  """Admin model def for Building."""

  search_fields = ['building_name', 'zumper_id',]
