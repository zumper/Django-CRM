  ...
  operations = [
      ...
      fields=[
        ...
        ('status', models.CharField(blank=True,
                                    choices=[('Planned', 'Planned'), ('Held', 'Held'), ('Not Held', 'Not Held'),
                                             ...
                                             ('Deferred', 'Deferred')], max_length=64, verbose_name='Status')),
        ...
        ('assigned_to',
         models.ManyToManyField(blank=True, related_name='event_assigned_users', to=settings.AUTH_USER_MODEL)),
        ('attendees_contacts',
         models.ManyToManyField(blank=True, related_name='attendees_contact', to='contacts.Contact')),
        ('attendees_leads', models.ManyToManyField(blank=True, related_name='attendees_lead', to='leads.Lead')),
        ('attendees_user',
         models.ManyToManyField(blank=True, related_name='attendees_user', to=settings.AUTH_USER_MODEL)),
        ('content_type',
         models.ForeignKey(blank=True, choices=[(10, 'Account'), (13, 'Lead'), (14, 'Opportunity'), (11, 'Case')],
                           limit_choices_to=models.Q(
                             models.Q(('app_label', 'account'), ('id', 10), ('model', 'Account')),
                             models.Q(('app_label', 'leads'), ('id', 13), ('model', 'Lead')),
                             models.Q(('app_label', 'opportunity'), ('id', 14), ('model', 'Opportunity')),
                             models.Q(('app_label', 'cases'), ('id', 11), ('model', 'Case')), _connector='OR'),
                           null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
        ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_created_by',
    ...
    migrations.AddField(
      ...
      field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                              related_name='updated_user', to=settings.AUTH_USER_MODEL),
    ),
  ]
